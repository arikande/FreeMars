 ...
 * @author Deniz ARIKAN
 */
public class NoDiplomacyAllowedTileDialog extends FreeMarsImageDialog {

    private static final int FRAME_WIDTH = 540;
    private static final int FRAME_HEIGHT = 390;

    public NoDiplomacyAllowedTileDialog(FreeMarsController freeMarsController, Player otherPlayer) {
        ...
        message.append("Sir,");
        message.append("<br><br>");
        message.append("This area belongs to ");
