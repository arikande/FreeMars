 ...
 * @author Deniz ARIKAN
 */
public class NoDiplomacyAllowedDialog extends FreeMarsImageDialog {

    private static final int FRAME_WIDTH = 540;
    private static final int FRAME_HEIGHT = 390;

    public NoDiplomacyAllowedDialog(FreeMarsController freeMarsController, Player otherPlayer) {
        ...
        message.append("Sir,");
        message.append("<br><br>");
        message.append("We can not open negotiations with ");
